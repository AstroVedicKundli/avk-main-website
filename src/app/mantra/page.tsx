...
export default function MantraPage() {
  ...
  const filteredMantras = mantras.filter((mantra) =>
    ...
    mantra.label.toLowerCase().includes(searchQuery.toLowerCase())
  );
        ...
        <div className="max-w-7xl mx-auto flex items-center justify-between gap-4">
          ...
          <div className="relative w-full max-w-md">
            <input
              ...
              className="w-full px-4 py-3 pl-12 rounded-lg border border-gray-300 focus:outline-none focus:ring-2 focus:ring-[#00BCD4] focus:border-transparent"
            />
            <svg
        ...
        <div className="max-w-7xl mx-auto">
          {filteredMantras.length === 0 ? (
            <div className="text-center py-12">
              <p className="text-gray-500 text-lg">No mantras found matching your search.</p>
            </div>
          ) : (
