    ...
    <div className="min-h-screen bg-gradient-to-b from-[#fefbf6] to-white">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div className="relative overflow-hidden rounded-3xl mb-16">
          <div className="absolute inset-0 bg-gradient-to-r from-[#FF7B60] via-[#ff6b4a] to-[#ff5b3a]"></div>
          <div className="absolute inset-0 opacity-10">
            <div className="absolute top-0 left-0 w-96 h-96 bg-[#333355] rounded-full filter blur-3xl"></div>
            <div className="absolute bottom-0 right-0 w-96 h-96 bg-[#333355] rounded-full filter blur-3xl"></div>
          </div>
            ...
            <div className="max-w-4xl mx-auto text-center">
              ...
              <div className="flex flex-wrap gap-4 justify-center">
                <div className="bg-white/10 backdrop-blur-sm rounded-xl px-6 py-3 border border-white/20">
                  ...
                  <div className="text-sm text-white/70">Trading Insights</div>
                </div>
                <div className="bg-white/10 backdrop-blur-sm rounded-xl px-6 py-3 border border-white/20">
                  <div className="text-2xl font-bold text-white">All Commodities</div>
                  <div className="text-sm text-white/70">Grains, Metals, Oil</div>
                </div>
                <div className="bg-white/10 backdrop-blur-sm rounded-xl px-6 py-3 border border-white/20">
                  <div className="text-2xl font-bold text-white">Price Trends</div>
                  <div className="text-sm text-white/70">Bullish & Bearish</div>
                </div>
              </div>
            </div>
          </div>
